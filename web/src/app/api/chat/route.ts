...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system: "You are an AI assistant for 'Big City', an app focused on helping users explore the city of Toronto. Use the tools provided to help the user plan their day in Toronto! USE NO MORE THAN 3 TOOL CALLS",
    onError: (error) => {
